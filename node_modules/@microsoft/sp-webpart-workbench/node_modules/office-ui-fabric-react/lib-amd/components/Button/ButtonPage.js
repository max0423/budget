...
define(["require", "exports", "react", "@uifabric/example-app-base", "office-ui-fabric-react/lib/Checkbox", "./examples/Button.Default.Example", "./examples/Button.ContextualMenu.Example", "./examples/Button.Primary.Example", "./examples/Button.Compound.Example", "./examples/Button.Command.Example", "./examples/Button.Icon.Example", "./examples/Button.Anchor.Example", "./examples/Button.ScreenReader.Example", "./examples/Button.Swap.Example", "../../Link", "./examples/Button.Basic.Example.scss"], function (require, exports, React, example_app_base_1, Checkbox_1, Button_Default_Example_1, Button_ContextualMenu_Example_1, Button_Primary_Example_1, Button_Compound_Example_1, Button_Command_Example_1, Button_Icon_Example_1, Button_Anchor_Example_1, Button_ScreenReader_Example_1, Button_Swap_Example_1, Link_1) {
    "use strict";
    ...
    var ButtonPage = (function (_super) {
        ...
        ButtonPage.prototype.render = function () {
            return (React.createElement(example_app_base_1.ComponentPage, { title: 'Button', componentName: 'ButtonExample', exampleCards: React.createElement("div", null,
                    ...
                    React.createElement(Checkbox_1.Checkbox, { label: 'Toggle buttons', checked: this.state.areButtonsToggled, onChange: this._onToggledChanged.bind(this) }),
                    React.createElement(example_app_base_1.ExampleCard, { title: 'Default Button', code: ButtonDefaultExampleCode },
                        React.createElement(Button_Default_Example_1.ButtonDefaultExample, { disabled: this.state.areButtonsDisabled, toggled: this.state.areButtonsToggled })),
                    React.createElement(example_app_base_1.ExampleCard, { title: 'Default NonToggle-able Button', code: ButtonDefaultExampleCode },
                    ...
                    React.createElement(example_app_base_1.ExampleCard, { title: 'Primary Button', code: ButtonPrimaryExampleCode },
                        React.createElement(Button_Primary_Example_1.ButtonPrimaryExample, { disabled: this.state.areButtonsDisabled, toggled: this.state.areButtonsToggled }),
                        " />"),
                    React.createElement(example_app_base_1.ExampleCard, { title: 'Compound Button', code: ButtonCompoundExampleCode },
                        React.createElement(Button_Compound_Example_1.ButtonCompoundExample, { disabled: this.state.areButtonsDisabled, toggled: this.state.areButtonsToggled }),
                        " />"),
                    React.createElement(example_app_base_1.ExampleCard, { title: 'Command Button', code: ButtonCommandExampleCode },
                        React.createElement(Button_Command_Example_1.ButtonCommandExample, { disabled: this.state.areButtonsDisabled, toggled: this.state.areButtonsToggled }),
                        " />"),
                    React.createElement(example_app_base_1.ExampleCard, { title: 'Icon Button', code: ButtonIconExampleCode },
                        React.createElement(Button_Icon_Example_1.ButtonIconExample, { disabled: this.state.areButtonsDisabled, toggled: this.state.areButtonsToggled }),
                        " />"),
                    React.createElement(example_app_base_1.ExampleCard, { title: 'Contextual Menu Button', code: ButtonContextualMenuExampleCode },
                        React.createElement(Button_ContextualMenu_Example_1.ButtonContextualMenuExample, { disabled: this.state.areButtonsDisabled, toggled: this.state.areButtonsToggled }),
                        " />"),
                    React.createElement(example_app_base_1.ExampleCard, { title: 'Button Like Anchor', code: ButtonAnchorExampleCode },
                        React.createElement(Button_Anchor_Example_1.ButtonAnchorExample, { disabled: this.state.areButtonsDisabled, toggled: this.state.areButtonsToggled }),
                        " />"),
                    React.createElement(example_app_base_1.ExampleCard, { title: 'Button with Aria Description for Screen Reader', code: ButtonScreenReaderExampleCode },
                        React.createElement(Button_ScreenReader_Example_1.ButtonScreenReaderExample, { disabled: this.state.areButtonsDisabled, toggled: this.state.areButtonsToggled }),
                        " />"),
                    React.createElement(example_app_base_1.ExampleCard, { title: 'Button Swap with Focus State', code: ButtonSwapExampleCode },
                        React.createElement(Button_Swap_Example_1.ButtonSwapExample, { disabled: this.state.areButtonsDisabled, toggled: this.state.areButtonsToggled }),
