...
export declare class ConnectedHost extends BaseComponent<IConnectedHostProps, IConnectedHostState> {
    static contextTypes: {
        stores: PropTypes.Requireable<any>;
    };
    context: {
        stores: StoreSet;
    };
    ...
    componentWillReceiveProps(newProps: IConnectedHostProps): void;
    shouldComponentUpdate(newProps: IConnectedHostProps, newState: IConnectedHostState): boolean;
    render(): JSX.Element;
