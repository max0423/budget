    ...
    var OverflowSetBasicExample = (function (_super) {
        ...
        OverflowSetBasicExample.prototype.render = function () {
            return (React.createElement(OverflowSet_1.OverflowSet, { items: [
                    ...
                    return (React.createElement(Button_1.IconButton, { className: Utilities_1.css(styles.overflowButton), iconProps: { iconName: 'More' }, menuIconProps: null, menuProps: { items: overflowItems } }));
