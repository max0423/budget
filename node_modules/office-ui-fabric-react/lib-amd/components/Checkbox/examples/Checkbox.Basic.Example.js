    ...
    var CheckboxBasicExample = (function (_super) {
        ...
        CheckboxBasicExample.prototype.render = function () {
            ...
            return (React.createElement("div", null,
                ...
                React.createElement(Checkbox_1.Checkbox, { label: 'Uncontrolled checkbox with defaultChecked true', defaultChecked: true, onChange: this._onCheckboxChange, style: { marginTop: 10 } }),
                React.createElement(Checkbox_1.Checkbox, { label: 'Disabled uncontrolled checkbox with defaultChecked true', disabled: true, defaultChecked: true, onChange: this._onCheckboxChange, style: { marginTop: 10 } }),
                ...
                React.createElement(Checkbox_1.Checkbox, { label: 'Checkbox rendered with boxSide "end"', boxSide: 'end', style: { marginTop: 10 } })));
        };
